    ...
    class Leet_Three_SumV3
    {
        ...
        public static List<int[]> FindZeroEntry(int[] nums, int target) {
            ...
            for (int idx1 = 0; idx1 <= nums.Length; idx1++)
            {
                ...
                { LoopProcSequentialDsc(rtnList, nums, idx1, idx2); }
            }
        ...
        //--------------------------------------------------------------------------------------------------------
        private static void LoopProcSequentialDsc(List<int[]> rtnList, int[] nums, int idx1, int idx2)
        {
            findZeroLoops += 1;
